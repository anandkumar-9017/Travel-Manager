...
class SeeMoreHotel extends StatefulWidget {
  final String name;

  SeeMoreHotel({this.name});

  @override
  _SeeMoreHotelState createState() => _SeeMoreHotelState(name);
}

class _SeeMoreHotelState extends State<SeeMoreHotel> {
  String name;
  QuerySnapshot hotels;
  var i = 3;

  _SeeMoreHotelState(name) {
    this.name = name;
  }
