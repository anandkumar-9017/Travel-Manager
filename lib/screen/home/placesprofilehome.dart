...
class PlacesProfile extends StatefulWidget {
  var keydata;
  var tripname;
  PlacesProfile(var keydata) {
    this.keydata = keydata;
  }
  @override
  _PlacesProfileState createState() => _PlacesProfileState(keydata);
}

class _PlacesProfileState extends State<PlacesProfile> {
  var keydata;
  var tripname;
  var about;
  var location;
  ...
  _PlacesProfileState(var keydata) {
    this.keydata = keydata;
  }
  ...
  void funct() async {
    ...
    price = hotels.data()["time required"];
